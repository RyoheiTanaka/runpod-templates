...
|---|---|---|
| `ComfyUI-ACE-Step1.5XL-FreeCraftLog` | `runpod/pytorch:2.4.0-py3.11-cuda12.4.1-devel-ubuntu22.04` | RTX 3090 / RTX 4090 など、まず通常検証する場合 |
| `ComfyUI-ACE-Step1.5XL-cuda12.8-FreeCraftLog` | `runpod/pytorch:2.8.0-py3.11-cuda12.8.1-cudnn-devel-ubuntu22.04` | RTX 5090 など CUDA 12.8 対応が必要な GPU |
...
```bash
bash -c 'RUNPOD_TEMPLATES_REF="${RUNPOD_TEMPLATES_REF:-v1.0.0}"; curl -fsSL "https://raw.githubusercontent.com/RyoheiTanaka/runpod-templates/${RUNPOD_TEMPLATES_REF}/templates/acestep15xl/setup.sh" | bash'
```
