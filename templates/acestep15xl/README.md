...
RTX 5090 など Blackwell 世代の GPU では CUDA 12.8 / PyTorch 2.8 image の `acestep15xl-cuda128` template を使ってください。

| Template | Container image | Use case |
|---|---|---|
| `acestep15xl` | `runpod/pytorch:2.4.0-py3.11-cuda12.4.1-devel-ubuntu22.04` | RTX 3090 / RTX 4090 など、まず通常検証する場合 |
| `acestep15xl-cuda128` | `runpod/pytorch:2.8.0-py3.11-cuda12.8.1-cudnn-devel-ubuntu22.04` | RTX 5090 など CUDA 12.8 対応が必要な GPU |
